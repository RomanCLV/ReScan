...
namespace ReScan::PreScan
{
	...
	int PreScanConfig::findPlanOffsetAndPeakRatio(const Point3D& point1, const Point3D& point2, const Point3D& point3, const PreScan::PreScanMode& mode, double& planOffset, double& peakRatio)
	{
