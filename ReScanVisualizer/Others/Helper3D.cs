...
namespace ReScanVisualizer
{
    public static class Helper3D
    {
        ...
        public static MeshGeometry3D BuildRectangleGeometry(Point3D center, double xLength, double yLength, double zLength, BoxFaces faces = BoxFaces.All)
        {
            MeshBuilder builder = new MeshBuilder(false, false);
            builder.AddBox(center, xLength, yLength, zLength, faces);
            return builder.ToMesh(true);
        }

        public static GeometryModel3D BuildRectangleModel(Point3D center, double xLength, double yLength, double zLength, Color color, BoxFaces faces = BoxFaces.All)
        {
            return BuildRectangleModel(center, xLength, yLength, zLength, new SolidColorBrush(color), faces);
        }

        public static GeometryModel3D BuildRectangleModel(Point3D center, double xLength, double yLength, double zLength, Brush brush, BoxFaces faces = BoxFaces.All)
        {
            return BuildRectangleModel(center, xLength, yLength, zLength, MaterialHelper.CreateMaterial(brush), faces);
        }

        public static GeometryModel3D BuildRectangleModel(Point3D center, double xLength, double yLength, double zLength, Material material, BoxFaces faces = BoxFaces.All)
        {
            return BuildModel(BuildRectangleGeometry(center, xLength, yLength, zLength, faces), material);
        }
